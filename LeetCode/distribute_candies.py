...
#   to brother and sister. Return the maximum number of kinds of candies the
#    sister could gain.
...
# Output: 3
# Explanation:
# There are three different kinds of candies (1, 2 and 3), and
#  two candies for each kind.
...
class Solution(object):
	...
	def distributeCandies(self,candies):
		...
		return min(len(candies)/2,len(candy_count))


def main():
	candies = [0,0,14,0,10,0,0,0]
	sol = Solution()
